...
const FAQS_BY_LANG = {
  ...
  ar: [
    { q: 'أين يمكنني مشاهدة كأس العالم 2026 مجاناً؟',
      a: 'تبث FIFA+ مباريات مختارة مجاناً حول العالم. في المنطقة العربية، تتوفر بعض المباريات على القنوات المفتوحة. تحقق من دليل القنوات المحلية.' },
    { q: 'ما القنوات التي تبث كأس العالم 2026؟',
      a: 'beIN Sports تبث جميع المباريات في المنطقة العربية. SSC تغطي المباريات في المملكة العربية السعودية.' },
    { q: 'هل يمكنني المشاهدة عبر الهاتف؟',
      a: 'نعم — تطبيق FIFA+ وتطبيق beIN CONNECT وتطبيقات المذيعين الرسمية تدعم البث على الهاتف المحمول.' },
  ],
  ja: [
    { q: 'ワールドカップ2026を無料で視聴できますか？',
      a: 'FIFA+が一部の試合を世界中で無料配信しています。日本ではABEMAが一部試合を無料で配信予定です。地上波の放送予定もご確認ください。' },
    { q: 'ワールドカップ2026はどのチャンネルで放送されますか？',
      a: '日本ではABEMA（全試合配信予定）、NHKおよび民放各局（地上波・BS）で放送されます。' },
    { q: 'スマートフォンで視聴できますか？',
      a: 'はい。FIFA+アプリ、ABEMAアプリ、各放送局の公式アプリでモバイル視聴が可能です。' },
  ],
  ko: [
    { q: '2026 월드컵을 무료로 시청할 수 있나요?',
      a: 'FIFA+에서 선별된 경기를 전 세계 무료 스트리밍합니다. 한국에서는 KBS와 MBC가 일부 경기를 지상파로 무료 중계합니다.' },
    { q: '2026 월드컵은 어떤 채널에서 방송하나요?',
      a: '한국에서는 KBS, MBC(지상파), 쿠팡플레이(전 경기 스트리밍)에서 시청할 수 있습니다.' },
    { q: '모바일로 시청할 수 있나요?',
      a: '네 — FIFA+ 앱, 쿠팡플레이 앱, 각 방송사 공식 앱에서 모바일 시청이 가능합니다.' },
  ],
}
